...
{!!Form::model($car, array('method' => 'PUT', 'id' => 'formData', 'enctype' => 'multipart/form-data', 'route' => array('admin.update', $car->id)))!!}
{{ csrf_field() }}
<section>
  <div class="form-group row justify-content-center">
      {{Form::label('make', 'Make: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('make', $car->make, ['id' => 'make', 'name' => 'make', 'placeholder' => 'Car Make', 'maxlength' => '50', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('model', 'Model: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('model', $car->model, ['id' => 'model', 'name' => 'model', 'placeholder' => 'Car Model', 'maxlength' => '100','class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('modelYear', 'Model Year: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('modelYear', $car->modelYear, ['id' => 'modelYear', 'name' => 'modelYear', 'placeholder' => 'Model Year', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('details', 'Details: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::textarea('details', $car->details, ['id' => 'details', 'maxlength' => '3000', 'placeholder' => 'Type Other Details', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('engineSize', 'Engine Size: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('engineSize', $car->engineSize, ['id' => 'engineSize', 'name' => 'engineSize', 'placeholder' => 'Engine Size', 'maxlength' => '30','class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('brochureSize', 'Brochure Size: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('brochureSize', $car->brochureSize, ['id' => 'brochureSize', 'name' => 'brochureSize', 'placeholder' => 'Brochure Size', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('topSpeed', 'Top Speed: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('topSpeed', $car->topSpeed, ['id' => 'topSpeed', 'name' => 'topSpeed', 'placeholder' => 'Top Speed', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('noughtToSixty', '0 To 60: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('noughtToSixty', $car->noughtToSixty, ['id' => 'noughtToSixty', 'name' => 'noughtToSixty', 'placeholder' => 'Nought To Sixty', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('enginePowerBHP', 'Engine Power(BHP): ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('enginePowerBHP', $car->enginePowerBHP, ['id' => 'enginePowerBHP', 'name' => 'enginePowerBHP', 'placeholder' => 'Engine BHP', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
          ...
          'Four Wheel Drive' => 'Four Wheel Drive', 'Other' => 'Other'], $car->drivetrain,
...
<section>
  <div class="form-group row justify-content-center">
      ...
      {{Form::text('economyUrban', $car->economyUrban, ['id' => 'economyUrban', 'name' => 'economyUrban', 'placeholder' => 'Economy (Urban)', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('economyExtraUrban', 'Economy(Extra Urban): ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('economyExtraUrban', $car->economyExtraUrban, ['id' => 'economyExtraUrban', 'name' => 'economyExtraUrban', 'placeholder' => 'Economy (Extra Urban)', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('economyCombined', 'Economy(Combined): ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('economyCombined', $car->economyCombined, ['id' => 'economyCombined', 'name' => 'economyCombined', 'placeholder' => 'Economy (Urban)', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('emissions', 'CO2 Emissions: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('emissions', $car->emissions, ['id' => 'emissions', 'name' => 'emissions', 'placeholder' => 'CO2 Emissions', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('annualTax', 'Annual Tax: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('annualTax', $car->annualTax, ['id' => 'annualTax', 'name' => 'annualTax', 'placeholder' => 'Annual Tax', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
</section>
<section>
  <div class="form-group row justify-content-center">
      {{Form::label('mileage', 'Mileage: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('mileage', $car->mileage, ['id' => 'mileage', 'name' => 'mileage', 'placeholder' => 'Mileage', 'maxlength' => '30', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('bodyType', 'Body Type: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('bodyType', $car->bodyType, ['id' => 'bodyType', 'name' => 'bodyType', 'placeholder' => 'Body Type', 'maxlength' => '50', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
...
<section>
  ...
  <div class="form-group row justify-content-center">
      ...
      {{Form::text('colour', $car->colour, ['id' => 'colour', 'name' => 'colour', 'placeholder' => 'Car Colour', 'maxlength' => '25', 'class' => 'col-sm-8 form-control'])}}
  </div>
  <div class="form-group row justify-content-center">
      {{Form::label('price', 'Price: ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::text('price', $car->price, ['id' => 'price', 'name' => 'price', 'placeholder' => 'Car Price', 'maxlength' => '6', 'class' => 'col-sm-8 form-control'])}}
  </div>
</section>
<section>
<h2>Images You Can Replace</h2>
<div class="form-group row justify-content-center">
      <div class="col-sm-1 edit-img-col">
          <img src="{{ asset('storage/car_images/'.$replacements[0].'.jpg') }}" class="edit-form-thumbnail" alt="thumbnail"/>
     </div>
     {{Form::label('carPicture', 'Main Car Picture: ', array('class' => 'col-sm-2 col-form-label'))}}
     {{Form::file('carPicture', ['id' => 'carPicture', 'name' => 'carPicture', 'class' => 'col-sm-8 form-control'])}}
</div>
@for ($i = 2;  $i <= count($replacements); $i++)
<div class="form-group row justify-content-center">
    <div class="col-sm-1 edit-img-col">
      <img src="{{ asset('storage/car_images/'.$replacements[$i - 1].'.jpg') }}" class="edit-form-thumbnail" alt="thumbnail"/>
    </div>
    {{Form::label('carPic'.$i, 'Car Pic '.$i.': ', array('class' => 'col-sm-2 col-form-label'))}}
    {{Form::file('carPic'.$i, ['name' => 'carPic'.$i, 'class' => 'col-sm-8 form-control'])}}
  </div>
@endfor
</section>
@if (count($replacements) < 10)
  <section>
    <h2>Image(s) You Can Add</h2>
    @for ($i = count($replacements) + 1; $i <= 10; $i++)
    <div class="form-group row justify-content-center">
      {{Form::label('carPic'.$i, 'Car Pic '.$i.': ', array('class' => 'col-sm-2 col-form-label'))}}
      {{Form::file('carPic'.$i, ['name' => 'carPic'.$i, 'class' => 'col-sm-8 form-control'])}}
    </div>
    ...
    <div class="form-group row justify-content-center">
        <div class="col-sm-8">
            <div class="form-group">
                <input type="hidden" name="replaceCount" id="replaceCount" value="{{ count($replacements) }}"/>
                <div class="flex-holder">
                    {{Form::submit('Update Car', ['class' => 'btn btn-primary btn-lg btn-block hidden-print'])}}
                </div>
            </div>
      </div>
    </div>
